...
class TestBankAccountTransfersHistory(unittest.TestCase):
    ...
    def test_historia_konto_osobiste_przychodzacy(self,czy_w_rejestrze):
    ...
    def test_historia_konto_osobiste_wychodzacy(self,czy_w_rejestrze):
        konto_1 = KontoOsobiste("imie","nazwisko","10000000000")
        konto_1.saldo = 100
        konto_1.przelew_wychodzacy(50)
        self.assertEqual(konto_1.historia, [-50], "historia niepoprawna!")
    def test_historia_konto_osobiste_express(self,czy_w_rejestrze):
        konto_1 = KontoOsobiste("imie","nazwisko","10000000000")
        konto_1.saldo = 300
